...
div.element-container:has(#login_marker) + div.element-container button {
    background-color: #28a745 !important;
    color: white !important;
    border-color: #28a745 !important;
    font-weight: bold !important;
}
div.element-container:has(#login_marker) + div.element-container button:hover {
...
def login_page():
    with st.form("login_form"):
        ...
        st.markdown('<div id="login_marker"></div>', unsafe_allow_html=True)
