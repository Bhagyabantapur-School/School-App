...
with st.expander("⚡ Busy Time Quick Entry", expanded=False):
...
# --- BUTTON TO CLEAR INCOMPLETE ENTRIES ---
if st.button("🧹 Clear Backlog (Incomplete Entries)", use_container_width=True):
    st.switch_page("money_incomplete.py")
