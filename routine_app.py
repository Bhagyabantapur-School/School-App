...
try:
    ...
    app_groups = {
        ...
        "ROUTINE": [("Live Routine Hub", "routine_app_2.py", "⏱️"), ("Routine Audit", "routine_audit.py", "🔍"), ("Routine Editor", "routine_editor.py", "✏️"), ("Project App", "project_app.py", "🚀"), ("AI Video Tracker", "ai_video_tracker.py", "🎬"), ("Courses", "courses.py", "📚")],
