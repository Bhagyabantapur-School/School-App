    ...
    with t_rout:
        ...
        if not today_logs.empty:
            ...
            for act, total_mins in summary.items():
                ...
                elif cat in ["WORK", "REPORT", "TASK", "HOME TASK", "HOME UTILITIES"]: card_color = "#0068c9"
                elif cat == "HEALTH": card_color = "#2e7b32"
                elif cat in ["SLEEP", "PRE", "TEA", "OUT"]: card_color = "#ff9f36"
                elif cat == "FREE TIME": card_color = "#29b6f6"
                else: card_color = "#78909c"
