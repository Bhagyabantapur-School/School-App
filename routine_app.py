...
try:
    ...
    # Show Scheduled Apps at the top if any exist
    ...
    if next_activity == "FLEX MODE ACTIVE": st.markdown('<h4 style="text-align: center; color: #e65100; margin-bottom: 20px; font-weight: 400; font-size: 1.1rem;">⚠️ Schedule Paused - Logging Custom Activity</h4>', unsafe_allow_html=True)
    elif next_activity not in ["NONE", "END OF DAY"]: st.markdown(f'<h4 style="text-align: center; color: #666; margin-bottom: 20px; font-weight: 400; font-size: 1.1rem;">Up Next: <b>{next_activity}</b> at {next_time_str}</h4>', unsafe_allow_html=True)
