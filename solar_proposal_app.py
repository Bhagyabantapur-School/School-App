...
if not action_df.empty:
    ...
    # Auto-generate Bengali Instructions based on Reason
    def get_bengali_instruction(reason):
        ...
        if "0" in r_lower or "sq ft" in r_lower or "zero" in r_lower or "space" in r_lower:
            ...
            return "আপনার দেওয়া তথ্যটি অসম্পূর্ণ বা ভুল। দয়া করে সঠিক তথ্য দিয়ে পুনরায় ফর্মটি সাবমিট করুন।"
        else:
            return "দয়া করে সঠিক তথ্য দিয়ে পুনরায় ফর্মটি সাবমিট করুন।"
